...
export default function RecreatingMagicSection() {
  ...
  return (
    <section
      ...
      className="scroll-mt-20 sm:scroll-mt-24 relative overflow-hidden bg-surface-dark z-20 section-padding section-padding-x"
    >
      ...
      <div className="relative container mx-auto flex flex-col">
        <div className="relative w-full aspect-video mx-auto mb-6 sm:mb-12 md:mb-16 mt-0 md:-mt-[40vh] max-w-full">
          <video
            ref={videoRef}
            autoPlay
            loop
