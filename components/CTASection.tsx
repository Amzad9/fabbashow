...
export default function CTASection() {
  return (
    <section aria-labelledby="cta-heading" className="relative overflow-hidden section-padding section-padding-x">
      {/* Background */}
      ...
      <div className="relative container mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          <div className="relative rounded-2xl sm:rounded-3xl md:rounded-4xl p-px bg-linear-to-b from-amber-400/60 via-amber-500/40 to-amber-600/60 shadow-[0_0_60px_rgba(251,191,36,0.15),inset_0_0_60px_rgba(251,191,36,0.03)]">
            <div className="rounded-2xl sm:rounded-3xl md:rounded-4xl bg-surface-dark/90 backdrop-blur-xl border border-white/5 px-6 py-12 sm:px-8 sm:py-16 md:px-14 md:py-20">
              ...
              <p className="text-sm sm:text-base md:text-lg text-amber-200/90 mb-8 sm:mb-10">
                Don&apos;t miss the party!
              </p>

              <a
                href="#events"
                className="focus-accent group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-8 py-3.5 sm:px-10 sm:py-4 md:px-14 md:py-5 rounded-full font-bold text-sm sm:text-base md:text-lg uppercase tracking-widest text-gray-900 min-h-[48px] transition-all duration-300 hover:shadow-[0_0_50px_rgba(251,191,36,0.4)] overflow-hidden"
                style={{
